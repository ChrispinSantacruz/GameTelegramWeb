  ...
  const developers = [
    {
      ...
      color: "green",
      social: {
        x: "https://x.com/SMKgfx1",
        telegram: "https://t.me/SMKstyle",
      },
    },
    {
      name: "ChrisCode",
      ...
      color: "blue",
      social: {
        github: "https://github.com/ChrisCodeX1",
        telegram: "https://t.me/Chris_CodeX",
      },
    },
  ]
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="flex justify-center space-x-4">
                      {dev.social.github && (
                        ...
                        >
                          <Link href={dev.social.github} target="_blank">
                      ...
                      {dev.social.x && (
                        <Button
                          ...
                          className={`border-2 ${colors.border} ${colors.text} ${colors.hover} hover:text-black`}
                        >
                          <Link href={dev.social.x} target="_blank">
                            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      {dev.social.telegram && (
                        <Button
                          ...
                          className={`border-2 ${colors.border} ${colors.text} ${colors.hover} hover:text-black`}
                        >
                          <Link href={dev.social.telegram} target="_blank">
